...
public:
    ...
    void init_charsets(const string csfile = "charset.txt");
    void init_ignore(const string csfile = "ignore.txt");
    void init_conversion(const string cofile = "conversion.txt");
